...
(function ($) {
	...
	DateTimePicker.prototype = {
		...
		setTime: function (format, $this) {
				 ...
				 * added code below by Br. Saket. 10-oct-2016
				 * Somehow format is showing up as having a type error
				 * Presumably format is undefined
				 * But still it is not solving the problem
				 */
